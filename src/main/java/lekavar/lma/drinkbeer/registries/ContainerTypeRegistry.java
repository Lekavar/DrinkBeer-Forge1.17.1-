...
public class ContainerTypeRegistry {
    ...
    public static final RegistryObject<MenuType<BeerBarrelContainer>> beerBarrelContainer = CONTAINERS.register("beer_barrel_container", () -> IForgeContainerType.create(BeerBarrelContainer::new));
